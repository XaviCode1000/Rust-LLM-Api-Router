...
This project is indexed by GitNexus as **Rust-LLM-Api-Router** (4803 symbols, 9964 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
