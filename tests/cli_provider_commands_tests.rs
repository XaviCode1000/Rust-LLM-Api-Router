...
async fn test_cli_list_providers_with_data() {
    ...
    repo.save(Provider::new("prov-1", "Provider 1", "https://prov1.com")).await.unwrap();
    repo.save(Provider::new("prov-2", "Provider 2", "https://prov2.com")).await.unwrap();
    repo.save(Provider::disabled("prov-3", "Provider 3", "https://prov3.com")).await.unwrap();
...
async fn test_cli_list_providers_displays_enabled_disabled() {
    ...
    repo.save(Provider::new("enabled-prov", "Enabled", "https://enabled.com")).await.unwrap();
    repo.save(Provider::disabled("disabled-prov", "Disabled", "https://disabled.com")).await.unwrap();
...
async fn test_cli_remove_provider_success() {
    ...
    repo.save(Provider::new("to-remove", "To Remove", "https://remove.com")).await.unwrap();
...
async fn test_cli_remove_provider_from_multiple() {
    ...
    repo.save(Provider::new("prov-1", "Provider 1", "https://prov1.com")).await.unwrap();
    repo.save(Provider::new("prov-2", "Provider 2", "https://prov2.com")).await.unwrap();
    repo.save(Provider::new("prov-3", "Provider 3", "https://prov3.com")).await.unwrap();
